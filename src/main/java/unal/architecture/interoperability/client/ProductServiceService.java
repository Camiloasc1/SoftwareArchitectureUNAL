 ...
 * 
 */
@WebServiceClient(name = "ProductServiceService", targetNamespace = "http://service.architecture.unal/", wsdlLocation = "classpath:wsdl/ProductService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName PRODUCTSERVICESERVICE_QNAME = new QName("http://service.architecture.unal/", "ProductServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("classpath:wsdl/ProductService.wsdl");
    ...
    public ProductService getProductServicePort() {
        return super.getPort(new QName("http://service.architecture.unal/", "ProductServicePort"), ProductService.class);
    }
    ...
    public ProductService getProductServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.architecture.unal/", "ProductServicePort"), ProductService.class, features);
    }
